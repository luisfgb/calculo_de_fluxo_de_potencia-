...
'Alguns resultados para o circuito 4 barras IEEE - Shape industrial'
import numpy as np
import matplotlib.pyplot as plt
import dss
dss_engine = dss.DSS
#Compilação do circuito em estudo
dss_engine.Text.Command = r'compile "C:\Users\luisf\OneDrive\Documentos\OpenDSS\IEEE4_python_IND\4bus_Ind_python.dss"'
...
plt.xlabel('Horas do dia')
plt.ylabel('kWh')
plt.title('Perdas para cada hora do dia - Load Shape Industrial',fontsize = 15)
plt.grid()
plt.show()
