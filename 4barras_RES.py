...
'Alguns resultados para o circuito 4 barras IEEE - Shape Residencial'
import numpy as np
...
dss_engine.Text.Command = r'compile "C:\Users\luisf\OneDrive\Documentos\OpenDSS\IEEE4_python\4bus_python.dss"'
...
plt.xlabel('Horas do dia')
plt.ylabel('kWh')
plt.title('Perdas para cada hora do dia - Load Shape Residencial',fontsize = 15)
plt.grid()
plt.show()
